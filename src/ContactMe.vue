<template>
    <div class="parallax-container contact-icons" id='contact-me' style="height: 100vh">
      <!-- <div class="parallax">
        <img src="" alt="" class='lozad-background background-3'>
      </div> -->
      <div class="fa-fonts">
      <a href="https://github.com/Bigghead" target='_blank'>
        <i class="fa fa-github-alt fa-5x" aria-hidden="true"></i>
      </a>
       <a href="https://codepen.io/Bigghead/pens/public" target='_blank'>
